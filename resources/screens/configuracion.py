...
def slider_layout(dificultad, datos):
    ...
    if dificultad == 'personalizado':
        ...
        lista_dificultades_sliders.append([sg.Slider(key='-time-',        default_value=datos['tiempo'], range=(30, 90), size=(20, 10),
        ...
        lista_dificultades_sliders.append([sg.Slider(key='-time-',        default_value=config[dificultad]['tiempo'], range=(30, 90), size=(20, 10),
